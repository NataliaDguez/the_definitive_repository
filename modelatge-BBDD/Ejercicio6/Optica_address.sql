...
CREATE TABLE `address` (
  ...
  `address_floor` decimal(10,0) DEFAULT NULL,
  `address_door` varchar(45) DEFAULT NULL,
  `address_cipcode` decimal(10,0) NOT NULL,
...
INSERT INTO `address` VALUES (1,'Calle Castilla','125',NULL,NULL,8009,'Aragon','España');
